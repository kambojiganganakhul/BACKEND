      ...
      <div className="card-body" >
       ...
       <div className="text-left">
        ...
        <form>
         ...
         <div className="mb-2">
           <label className="fw-bold text-primary">EDUCATION</label>
           <input type="text" value={DocMs} onChange={(e)=>SetDocMs(e.target.value)}
            className="form-control" placeholder="Enter Your Education" required z/>
         </div>
                        
         <div className="mb-2">
           <label  className="fw-bold text-primary">FATHER NAME</label>
